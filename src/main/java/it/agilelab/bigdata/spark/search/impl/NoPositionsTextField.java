...
public final class NoPositionsTextField extends Field {
     ...
     */
    public NoPositionsTextField(String name, Reader reader) {
     ...
     */
    public NoPositionsTextField(String name, String value, Store store) {
     ...
     */
    public NoPositionsTextField(String name, TokenStream stream) {
